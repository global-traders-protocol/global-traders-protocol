...
contract GTPVesting is Ownable {

    /// @notice GTP token contract
    IBEP20 public immutable gtp;
     ...
     * @param gtp_ Address of the GTP contract
     * @param vestingBegin_ Timestamp of the vesting begin time
     * @param vestingEnd_ Timestamp of the vesting end time
     */
    constructor(IBEP20 gtp_, uint256 vestingBegin_, uint256 vestingEnd_) Ownable() {
    ...
    function claim(address account) external {
        ...
        require(gtp.transfer(account, totalAmount), "Vesting::claim: transfer error");
    }
    ...
    function holdTokens(HoldParams[] memory params) external onlyOwner {
        ...
        require(gtp.transferFrom(msg.sender, address(this), totalAmount), "Vesting::holdTokens: transfer failed");
